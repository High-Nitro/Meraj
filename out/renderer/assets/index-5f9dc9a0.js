...
function R$1(a, b, e, d, c) {
  ...
  if (h)
    return h = a, c = c(h), a = "" === d ? "." + Q$2(h, 0) : d, I$2(c) ? (e = "", null != a && (e = a.replace(P$2, "$&/") + "/"), R$1(c, b, e, "", function(a2) {
      return a2;
  ...
  if (I$2(a))
    ...
    for (a = f2.call(a), g = 0; !(k2 = a.next()).done; )
      k2 = k2.value, f2 = d + Q$2(k2, g++), h += R$1(k2, b, e, f2, c);
  else if ("object" === k2)
...
function ii(a, b) {
  var c = N$1, d = di(), e = b(), f2 = !He(d.memoizedState, e);
...
function Di(a, b, c) {
  ...
  He(c, b) || (c = yc(), N$1.lanes |= c, hh |= c, a.baseState = true);
  return b;
}
function Ei(a, b) {
  var c = C;
    ...
    case 13:
      ...
      if (null !== d) {
        if (null !== d.dehydrated)
          return G$1(M, M.current & 1), b.flags |= 128, null;
...
function Fj(a, b, c) {
  ...
  switch (b.tag) {
    ...
    case 19:
      ...
      if (null !== f2.tail)
        return b = f2.tail, f2.rendering = b, f2.tail = b.sibling, f2.renderingStartTime = B$1(), b.sibling = null, c = M.current, G$1(M, d ? c & 1 | 2 : c & 1), b;
      S(b);
      return null;
    case 22:
    case 23:
...
var mk = Math.ceil, nk = ua.ReactCurrentDispatcher, ok = ua.ReactCurrentOwner, pk = ua.ReactCurrentBatchConfig, K$1 = 0, R = null, Y = null, Z$1 = 0, gj = 0, fj = Uf(0), T = 0, qk = null, hh = 0, rk = 0, sk = 0, tk = null, uk = null, gk = 0, Hj = Infinity, vk = null, Pi = false, Qi = null, Si = null, wk = false, xk = null, yk = 0, zk = 0, Ak = null, Bk = -1, Ck = 0;
function L$1() {
...
function mh(a, b, c, d) {
  ...
  Ac(a, c, d);
  if (0 === (K$1 & 2) || a !== R)
    a === R && (0 === (K$1 & 2) && (rk |= c), 4 === T && Dk(a, Z$1)), Ek(a, d), 1 === c && 0 === K$1 && 0 === (b.mode & 1) && (Hj = B$1() + 500, fg && jg());
}
function Ek(a, b) {
...
function Ui(a, b, c) {
  ...
  R === a && (Z$1 & c) === c && (4 === T || 3 === T && (Z$1 & 130023424) === Z$1 && 500 > B$1() - gk ? Lk(a, 0) : sk |= c);
  Ek(a, b);
}
function Zk(a, b) {
...
function getUrlBasedHistory(getLocation, createHref, validateLocation, options) {
  ...
  if (index2 == null) {
    index2 = 0;
    globalHistory.replaceState(_extends$e({}, globalHistory.state, {
      idx: index2
    }), "");
  }
  function getIndex() {
...
function HashRouter(_ref2) {
  ...
  let setState = reactExports.useCallback((newState) => {
    "startTransition" in React$1 ? reactExports.startTransition(() => setStateImpl(newState)) : setStateImpl(newState);
  }, [setStateImpl]);
...
const Link = /* @__PURE__ */ reactExports.forwardRef(function LinkWithRef(_ref4, ref) {
  ...
  return (
    ...
    /* @__PURE__ */ reactExports.createElement("a", _extends$c({}, rest, {
...
function toFormData(obj, formData, options) {
  ...
  function build(value2, path) {
    ...
    stack.push(value2);
    utils.forEach(value2, function each(el2, key) {
...
const SearchProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SearchContext.Provider, { value: value2, children });
};
const useSearch = () => reactExports.useContext(SearchContext);
function NavItem({ label, to }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to, className: "item", children: label });
}
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main grid", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logo col-3", style: styles$1.logo, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: styles$1.logoText, children: "Havij Movie" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search col-6", style: styles$1.search, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "pi pi-search", style: styles$1.searchIcon })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { label: "صفحه اصلی", to: "/" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { label: "فیلم ها", to: "/movies" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { label: "سریال ها", to: "/series" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { label: "مورد علاقه ها", to: "/favorites" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { label: "درباره ما", to: "/about" })
        ] })
      ]
    }
  );
...
const styles$1 = {
  ...
  search: {
    ...
    position: "relative",
    width: "50%",
    // حداکثر عرض فیلد جستجو
    paddingLeft: "1px"
    // فاصله بیشتر از سمت چپ
  },
  searchInput: {
    width: "100%",
    padding: "1px 15px",
  ...
  nav: {
    display: "flex",
    justifyContent: "center",
    // تغییر به مرکز برای کاهش فاصله‌ها
    marginTop: "20px",
    gap: "20px"
    // فاصله کمتر بین آیتم‌های ناوبری
  }
};
const logoAnimation = `
@keyframes pulse {
...
styleSheet$1.type = "text/css";
styleSheet$1.innerText = logoAnimation;
...
`);
var L = (t2) => typeof t2 == "number" && !isNaN(t2), N = (t2) => typeof t2 == "string", P = (t2) => typeof t2 == "function", mt = (t2) => N(t2) || L(t2), B = (t2) => N(t2) || P(t2) ? t2 : null, pt = (t2, o) => t2 === false || L(t2) && t2 > 0 ? t2 : o, z = (t2) => reactExports.isValidElement(t2) || N(t2) || P(t2) || L(t2);
function Z(t2, o, e = 300) {
  let { scrollHeight: r2, style: s } = t2;
...
function $({ enter: t2, exit: o, appendPosition: e = false, collapse: r2 = true, collapseDuration: s = 300 }) {
  return function({ children: a, position: d, preventExitTransition: c, done: T2, nodeRef: g, isIn: v2, playToast: x2 }) {
    let C2 = e ? `${t2}--${d}` : t2, S2 = e ? `${o}--${d}` : o, E2 = reactExports.useRef(0);
    return reactExports.useLayoutEffect(() => {
      let f2 = g.current, p2 = C2.split(" "), b = (n2) => {
        n2.target === g.current && (x2(), f2.removeEventListener("animationend", b), f2.removeEventListener("animationcancel", b), E2.current === 0 && n2.type !== "animationcancel" && f2.classList.remove(...p2));
      };
      (() => {
      ...
      let f2 = g.current, p2 = () => {
        f2.removeEventListener("animationend", p2), r2 ? Z(f2, T2, s) : T2();
      };
      v2 || (c ? p2() : (() => {
...
function tt(t2, o, e = false) {
  return reactExports.isValidElement(t2) && !N(t2.type) ? reactExports.cloneElement(t2, { closeToast: o.closeToast, toastProps: o, data: o.data, isPaused: e }) : P(t2) ? t2({ closeToast: o.closeToast, toastProps: o, data: o.data, isPaused: e }) : t2;
}
function yt({ closeToast: t2, theme: o, ariaLabel: e = "close" }) {
...
function gt({ delay: t2, isRunning: o, closeToast: e, type: r2 = "default", hide: s, className: l2, controlledProgress: a, progress: d, rtl: c, isIn: T2, theme: g }) {
  let v2 = s || a && d === 0, x2 = { animationDuration: `${t2}ms`, animationPlayState: o ? "running" : "paused" };
  a && (x2.transform = `scaleX(${d})`);
  let C2 = clsx("Toastify__progress-bar", a ? "Toastify__progress-bar--controlled" : "Toastify__progress-bar--animated", `Toastify__progress-bar-theme--${g}`, `Toastify__progress-bar--${r2}`, { ["Toastify__progress-bar--rtl"]: c }), S2 = P(l2) ? l2({ rtl: c, type: r2, defaultClassName: C2 }) : clsx(C2, l2), E2 = { [a && d >= 1 ? "onTransitionEnd" : "onAnimationEnd"]: a && d < 1 ? null : () => {
    T2 && e();
  } };
  return React.createElement("div", { className: "Toastify__progress-bar--wrp", "data-hidden": v2 }, React.createElement("div", { className: `Toastify__progress-bar--bg Toastify__progress-bar-theme--${g} Toastify__progress-bar--${r2}` }), React.createElement("div", { role: "progressbar", "aria-hidden": v2 ? "true" : "false", "aria-label": "notification timer", className: S2, style: x2, ...E2 }));
}
var Xt = 1, at = () => `${Xt++}`;
function _t(t2, o, e) {
  let r2 = 1, s = 0, l2 = [], a = [], d = o, c = /* @__PURE__ */ new Map(), T2 = /* @__PURE__ */ new Set(), g = (i) => (T2.add(i), () => T2.delete(i)), v2 = () => {
    a = Array.from(c.values()), T2.forEach((i) => i());
  }, x2 = ({ containerId: i, toastId: n2, updateId: u2 }) => {
    let h = i ? i !== t2 : t2 !== 1, m2 = c.has(n2) && u2 == null;
    return h || m2;
  }, C2 = (i, n2) => {
    c.forEach((u2) => {
      var h;
      (n2 == null || n2 === u2.props.toastId) && ((h = u2.toggle) == null || h.call(u2, i));
    });
  }, S2 = (i) => {
    var n2, u2;
    (u2 = (n2 = i.props) == null ? void 0 : n2.onClose) == null || u2.call(n2, i.removalReason), i.isActive = false;
  }, E2 = (i) => {
    if (i == null)
      c.forEach(S2);
    else {
    ...
    var m2, _;
    let { toastId: n2, updateId: u2 } = i.props, h = u2 == null;
    i.staleId && c.delete(i.staleId), i.isActive = true, c.set(n2, i), v2(), e(J(i, h ? "added" : "updated")), h && ((_ = (m2 = i.props).onOpen) == null || _.call(m2));
  };
  return { id: t2, props: d, observe: g, toggle: C2, removeToast: E2, toasts: c, clearQueue: f2, buildToast: (i, n2) => {
    if (x2(n2))
      return;
    let { toastId: u2, updateId: h, data: m2, staleId: _, delay: k2 } = n2, M2 = h == null;
    M2 && s++;
    let A2 = { ...d, style: d.toastStyle, key: r2++, ...Object.fromEntries(Object.entries(n2).filter(([D2, Y2]) => Y2 != null)), toastId: u2, updateId: h, data: m2, isIn: false, className: B(n2.className || d.toastClassName), progressClassName: B(n2.progressClassName || d.progressClassName), autoClose: n2.isLoading ? false : pt(n2.autoClose, d.autoClose), closeToast(D2) {
      c.get(u2).removalReason = D2, E2(u2);
    }, deleteToast() {
      let D2 = c.get(u2);
      if (D2 != null) {
        if (e(J(D2, "removed")), c.delete(u2), s--, s < 0 && (s = 0), l2.length > 0) {
          p2(l2.shift());
          return;
        }
        v2();
    ...
    A2.closeButton = d.closeButton, n2.closeButton === false || z(n2.closeButton) ? A2.closeButton = n2.closeButton : n2.closeButton === true && (A2.closeButton = z(d.closeButton) ? d.closeButton : true);
    let R2 = { content: i, props: A2, staleId: _ };
    d.limit && d.limit > 0 && s > d.limit && M2 ? l2.push(R2) : L(k2) ? setTimeout(() => {
      p2(R2);
    }, k2) : p2(R2);
  }, setProps(i) {
    d = i;
...
var I = /* @__PURE__ */ new Map(), F = [], st = /* @__PURE__ */ new Set(), Vt = (t2) => st.forEach((o) => o(t2)), bt = () => I.size > 0;
function Qt() {
  F.forEach((t2) => nt(t2.content, t2.options)), F = [];
}
var vt = (t2, { containerId: o }) => {
  var e;
  return (e = I.get(o || 1)) == null ? void 0 : e.toasts.get(t2);
};
function X(t2, o) {
  var r2;
  if (o)
    return !!((r2 = I.get(o)) != null && r2.isToastActive(t2));
  let e = false;
  return I.forEach((s) => {
    s.isToastActive(t2) && (e = true);
  }), e;
}
function ht(t2) {
  if (!bt()) {
    F = F.filter((o) => t2 != null && o.options.toastId !== t2);
    return;
  }
  if (t2 == null || mt(t2))
    I.forEach((o) => {
    ...
    let o = I.get(t2.containerId);
    o ? o.removeToast(t2.id) : I.forEach((e) => {
      e.removeToast(t2.id);
    });
  }
}
...
function nt(t2, o) {
  z(t2) && (bt() || F.push({ content: t2, options: o }), I.forEach((e) => {
    e.buildToast(t2, o);
  }));
}
function xt(t2) {
  var o;
  (o = I.get(t2.containerId || 1)) == null || o.setToggle(t2.id, t2.fn);
}
function rt(t2, o) {
  I.forEach((e) => {
...
function Q(t2) {
  return (o, e) => U(o, V(t2, e));
}
function y(t2, o) {
  return U(t2, V("default", o));
}
y.loading = (t2, o) => U(t2, V("default", { isLoading: true, autoClose: false, closeOnClick: false, closeButton: false, draggable: false, ...o }));
function Gt(t2, { pending: o, error: e, success: r2 }, s) {
  let l2;
  o && (l2 = N(o) ? y.loading(o, s) : y.loading(o.render, { ...s, ...o }));
  let a = { isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null }, d = (T2, g, v2) => {
    if (g == null) {
      y.dismiss(l2);
      return;
    }
    let x2 = { type: T2, ...a, ...s, data: v2 }, C2 = N(g) ? { render: g } : g;
    return l2 ? y.update(l2, { ...x2, ...C2 }) : y(C2.render, { ...x2, ...C2 }), v2;
  }, c = P(t2) ? t2() : t2;
  return c.then((T2) => d("success", r2, T2)).catch((T2) => d("error", e, T2)), c;
}
y.promise = Gt;
y.success = Q("success");
y.info = Q("info");
...
y.warning = Q("warning");
y.warn = y.warning;
y.dark = (t2, o) => U(t2, V("default", { theme: "dark", ...o }));
function qt(t2) {
  ht(t2);
}
y.dismiss = qt;
...
y.update = (t2, o = {}) => {
  let e = vt(t2, o);
  if (e) {
    let { props: r2, content: s } = e, l2 = { delay: 100, ...r2, ...o, toastId: o.toastId || t2, updateId: at() };
...
function It(t2) {
  ...
  function l2(d) {
    ...
    return t2.newestOnTop && s.reverse(), s.forEach((T2) => {
      let { position: g } = T2.props;
      c.has(g) || c.set(g, []), c.get(g).push(T2);
    }), Array.from(c, (T2) => d(T2[0], T2[1]));
  }
  return { getToastToRender: l2, isToastActive: X, count: s == null ? void 0 : s.length };
}
function At(t2) {
  let [o, e] = reactExports.useState(false), [r2, s] = reactExports.useState(false), l2 = reactExports.useRef(null), a = reactExports.useRef({ start: 0, delta: 0, removalDistance: 0, canCloseOnClick: true, canDrag: false, didMove: false }).current, { autoClose: d, pauseOnHover: c, closeToast: T2, onClick: g, closeOnClick: v2 } = t2;
  xt({ id: t2.toastId, containerId: t2.containerId, fn: e }), reactExports.useEffect(() => {
    if (t2.pauseOnFocusLoss)
      return x2(), () => {
        C2();
      };
  }, [t2.pauseOnFocusLoss]);
  ...
  function S2(m2) {
    if (t2.draggable === true || t2.draggable === m2.pointerType) {
      b();
      let _ = l2.current;
      a.canCloseOnClick = true, a.canDrag = true, _.style.transition = "none", t2.draggableDirection === "x" ? (a.start = m2.clientX, a.removalDistance = _.offsetWidth * (t2.draggablePercent / 100)) : (a.start = m2.clientY, a.removalDistance = _.offsetHeight * (t2.draggablePercent === 80 ? t2.draggablePercent * 1.5 : t2.draggablePercent) / 100);
    }
  }
  function E2(m2) {
    let { top: _, bottom: k2, left: M2, right: A2 } = l2.current.getBoundingClientRect();
    m2.nativeEvent.type !== "touchend" && t2.pauseOnHover && m2.clientX >= M2 && m2.clientX <= A2 && m2.clientY >= _ && m2.clientY <= k2 ? p2() : f2();
  }
  function f2() {
    e(true);
  }
  ...
  function n2(m2) {
    ...
    if (a.canDrag && _) {
      ...
      _.style.transform = `translate3d(${k2},0)`, _.style.opacity = `${1 - Math.abs(a.delta / a.removalDistance)}`;
    }
  }
  function u2() {
    i();
  ...
  let h = { onPointerDown: S2, onPointerUp: E2 };
  return d && c && (h.onMouseEnter = p2, t2.stacked || (h.onMouseLeave = f2)), v2 && (h.onClick = (m2) => {
    g && g(m2), a.canCloseOnClick && T2(true);
  }), { playToast: f2, pauseToast: p2, isRunning: o, preventExitTransition: r2, toastRef: l2, eventHandlers: h };
}
var Ot = typeof window != "undefined" ? reactExports.useLayoutEffect : reactExports.useEffect;
var G = ({ theme: t2, type: o, isLoading: e, ...r2 }) => React.createElement("svg", { viewBox: "0 0 24 24", width: "100%", height: "100%", fill: t2 === "colored" ? "currentColor" : `var(--toastify-icon-color-${o})`, ...r2 });
function ao(t2) {
  return React.createElement(G, { ...t2 }, React.createElement("path", { d: "M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z" }));
}
function so(t2) {
  return React.createElement(G, { ...t2 }, React.createElement("path", { d: "M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z" }));
}
function no(t2) {
  return React.createElement(G, { ...t2 }, React.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}
function ro(t2) {
  return React.createElement(G, { ...t2 }, React.createElement("path", { d: "M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z" }));
}
function io() {
  return React.createElement("div", { className: "Toastify__spinner" });
}
var W = { info: so, warning: ao, success: no, error: ro, spinner: io }, lo = (t2) => t2 in W;
function Nt({ theme: t2, type: o, isLoading: e, icon: r2 }) {
  let s = null, l2 = { theme: t2, type: o };
...
var wt = (t2) => {
  let { isRunning: o, preventExitTransition: e, toastRef: r2, eventHandlers: s, playToast: l2 } = At(t2), { closeButton: a, children: d, autoClose: c, onClick: T2, type: g, hideProgressBar: v2, closeToast: x2, transition: C2, position: S2, className: E2, style: f2, progressClassName: p2, updateId: b, role: i, progress: n2, rtl: u2, toastId: h, deleteToast: m2, isIn: _, isLoading: k2, closeOnClick: M2, theme: A2, ariaLabel: R2 } = t2, D2 = clsx("Toastify__toast", `Toastify__toast-theme--${A2}`, `Toastify__toast--${g}`, { ["Toastify__toast--rtl"]: u2 }, { ["Toastify__toast--close-on-click"]: M2 }), Y2 = P(E2) ? E2({ rtl: u2, position: S2, type: g, defaultClassName: D2 }) : clsx(D2, E2), ft = Nt(t2), dt = !!n2 || !c, j = { closeToast: x2, type: g, theme: A2 }, H2 = null;
  return a === false || (P(a) ? H2 = a(j) : reactExports.isValidElement(a) ? H2 = reactExports.cloneElement(a, j) : H2 = yt(j)), React.createElement(C2, { isIn: _, done: m2, position: S2, preventExitTransition: e, nodeRef: r2, playToast: l2 }, React.createElement("div", { id: h, tabIndex: 0, onClick: T2, "data-in": _, className: Y2, ...s, style: f2, ref: r2, ..._ && { role: i, "aria-label": R2 } }, ft != null && React.createElement("div", { className: clsx("Toastify__toast-icon", { ["Toastify--animate-icon Toastify__zoom-enter"]: !k2 }) }, ft), tt(d, t2, !o), H2, !t2.customProgressBar && React.createElement(gt, { ...b && !dt ? { key: `p-${b}` } : {}, rtl: u2, theme: A2, delay: c, isRunning: o, isIn: _, closeToast: x2, hide: v2, type: g, className: p2, controlledProgress: dt, progress: n2 || 0 })));
};
var K = (t2, o = false) => ({ enter: `Toastify--animate Toastify__${t2}-enter`, exit: `Toastify--animate Toastify__${t2}-exit`, appendPosition: o }), lt = $(K("bounce", true));
...
function Lt(t2) {
  let o = { ..._o, ...t2 }, e = t2.stacked, [r2, s] = reactExports.useState(true), l2 = reactExports.useRef(null), { getToastToRender: a, isToastActive: d, count: c } = It(o), { className: T2, style: g, rtl: v2, containerId: x2, hotKeys: C2 } = o;
  function S2(f2) {
    let p2 = clsx("Toastify__toast-container", `Toastify__toast-container--${f2}`, { ["Toastify__toast-container--rtl"]: v2 });
    return P(T2) ? T2({ position: f2, rtl: v2, defaultClassName: p2 }) : clsx(p2, B(T2));
  }
  function E2() {
    e && (s(true), y.play());
  }
  return Ot(() => {
    var f2;
    if (e) {
      let p2 = l2.current.querySelectorAll('[data-in="true"]'), b = 12, i = (f2 = o.position) == null ? void 0 : f2.includes("top"), n2 = 0, u2 = 0;
      Array.from(p2).reverse().forEach((h, m2) => {
        let _ = h;
        _.classList.add("Toastify__toast--stacked"), m2 > 0 && (_.dataset.collapsed = `${r2}`), _.dataset.pos || (_.dataset.pos = i ? "top" : "bot");
        let k2 = n2 * (r2 ? 0.2 : 1) + (r2 ? 0 : b * m2);
        _.style.setProperty("--y", `${i ? k2 : k2 * -1}px`), _.style.setProperty("--g", `${b}`), _.style.setProperty("--s", `${1 - (r2 ? u2 : 0)}`), n2 += _.offsetHeight, u2 += 0.025;
      });
    }
    ...
    function f2(p2) {
      var i;
      let b = l2.current;
      C2(p2) && ((i = b.querySelector('[tabIndex="0"]')) == null || i.focus(), s(false), y.pause()), p2.key === "Escape" && (document.activeElement === b || b != null && b.contains(document.activeElement)) && (s(true), y.play());
    }
    return document.addEventListener("keydown", f2), () => {
      document.removeEventListener("keydown", f2);
    };
  }, [C2]), React.createElement("section", { ref: l2, className: "Toastify", id: x2, onMouseEnter: () => {
    e && (s(false), y.pause());
    ...
    return React.createElement("div", { tabIndex: -1, className: S2(f2), "data-stacked": e, style: b, key: `c-${f2}` }, p2.map(({ content: i, props: n2 }) => React.createElement(wt, { ...n2, stacked: e, collapseAll: E2, isIn: d(n2.toastId, n2.containerId), key: `t-${n2.key}` }, i)));
  }));
}
const ReactToastify = "";
...
const DataProvider = ({ children }) => {
  const [selectedMovie, setSelectedMovie] = reactExports.useState(null);
  const [userData, setUserData] = reactExports.useState(dataTemplate);
  const getUserData = () => {
    const data = window.api.getUserData();
    if (data)
      setUserData(data);
  };
  const addFav = (id2 = selectedMovie) => {
    const data = window.api.addFav(id2);
    if (data)
      setUserData(data);
  };
  const delFav = (id2 = selectedMovie) => {
    const data = window.api.delFav(id2);
    if (data)
      setUserData(data);
  };
  const markAsWatched = (id2) => {
    const data = window.api.markAsWatched(id2);
    if (data)
      setUserData(data);
  };
  const markAsUnwatched = (id2) => {
    const data = window.api.markAsUnwatched(id2);
    if (data)
      setUserData(data);
  };
  const value2 = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DataContext.Provider, { value: value2, children });
};
...
const useHorizontalScroll = () => {
  ...
  reactExports.useEffect(() => {
    ...
    const handleScroll = (event) => {
      if (event.target.parentElement.className !== "image" && event.target.className !== "list")
        return;
      if (event.deltaX !== 0)
        return;
      event.preventDefault();
...
const useSerie = () => {
  const [Series2, setSeries] = reactExports.useState([]);
  const [Seasons, setSeasons] = reactExports.useState([]);
  const [pending, setPending] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const [page, setPage] = reactExports.useState(0);
  const getSeries = async (order = "created", filter3 = 0, getPage = 0) => {
    setPending(true);
    setPage(Math.abs(getPage));
    const orders = ["created", "rating", "imdb", "title", "view"];
    if (!orders.includes(order))
      order = "created";
    const { res, err } = await API(`serie/by/filtres/${filter3}/${order}/${page}/1`);
    if (res) {
      setError(null);
      setSeries(res.data);
    }
  ...
  const getMore = async (order = "created", filter3 = 0) => {
    setPending(true);
    setPage(page + 1);
    const orders = ["created", "rating", "imdb", "title", "view"];
    if (!orders.includes(order))
      order = "created";
    const { res, err } = await API(`serie/by/filtres/${filter3}/${order}/${page + 1}/1`);
    if (res) {
      setError(null);
      setSeries([...Series2, ...res.data]);
    }
    if (err) {
      setError(err);
      setSeries(null);
  ...
  const getSeasons = async (id2) => {
    setPending(true);
    const { res, err } = await API(`season/by/serie/${id2}/1`);
    if (res) {
      setError(null);
      setSeasons(res.data);
    }
  ...
  return { Series: Series2, pending, error, getSeries, getMore, getSeasons, Seasons };
};
    ...
    for (var i = 0; i < args.length; i++) {
      ...
      if (type === "string" || type === "number") {
        ...
        var _classes = Array.isArray(className) ? className : Object.entries(className).map(function(_ref) {
          var _ref2 = _slicedToArray$b(_ref, 2), key = _ref2[0], value2 = _ref2[1];
...
var DomHandler = /* @__PURE__ */ function() {
  function DomHandler2() {
    _classCallCheck$7(this, DomHandler2);
  }
  _createClass$7(DomHandler2, null, [{
    key: "innerWidth",
    value: (
      /**
    ...
    value: function getViewport() {
      var win = window, d = document, e = d.documentElement, g = d.getElementsByTagName("body")[0], w2 = win.innerWidth || e.clientWidth || g.clientWidth, h = win.innerHeight || e.clientHeight || g.clientHeight;
      return {
        width: w2,
        height: h
      };
    ...
    value: function flipfitCollision(element, target) {
      ...
      var at2 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "left bottom";
    ...
    value: function getScrollableParents(element) {
      ...
      if (element) {
        ...
        var _iterator = _createForOfIteratorHelper$2(parents), _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            ...
            if (scrollSelectors) {
              ...
              var _iterator2 = _createForOfIteratorHelper$2(selectors), _step2;
              try {
    ...
    value: function getFocusableElements(element) {
      ...
      var _iterator3 = _createForOfIteratorHelper$2(focusableElements), _step3;
      try {
    ...
    key: "focus",
    value: function focus(el2, scrollTo) {
    ...
    value: function focusFirstElement(el2, scrollTo) {
      if (!el2)
        return;
...
_defineProperty$7(DomHandler, "DATA_PROPS", ["data-"]);
_defineProperty$7(DomHandler, "ARIA_PROPS", ["aria", "focus-target"]);
function EventBus() {
...
var ObjectUtils$5 = /* @__PURE__ */ function() {
  function ObjectUtils2() {
    _classCallCheck$7(this, ObjectUtils2);
  }
  _createClass$7(ObjectUtils2, null, [{
    key: "equals",
    ...
    value: function isEmpty(value2) {
      return value2 === null || value2 === void 0 || value2 === "" || Array.isArray(value2) && value2.length === 0 || !(value2 instanceof Date) && _typeof$c(value2) === "object" && Object.keys(value2).length === 0;
    }
  }, {
    key: "isNotEmpty",
...
var IconUtils = /* @__PURE__ */ function() {
  function IconUtils2() {
    _classCallCheck$7(this, IconUtils2);
  }
  _createClass$7(IconUtils2, null, [{
    key: "getJSXIcon",
    value: function getJSXIcon(icon) {
      ...
      if (icon !== null) {
        ...
        if (iconType !== "string") {
          ...
          return ObjectUtils$5.getJSXElement(icon, defaultContentOptions);
        }
      }
      return content;
    }
...
function _toConsumableArray$2(arr) {
  return _arrayWithoutHoles$2(arr) || _iterableToArray$2(arr) || _unsupportedIterableToArray$1$2(arr) || _nonIterableSpread$2();
}
function handler() {
  var zIndexes = [];
  ...
  return {
    get: getZIndex,
    set: function set(key, el2, autoZIndex, baseZIndex) {
      if (el2) {
...
var FilterService = {
  filter: function filter2(value2, fields, filterValue, filterMatchMode, filterLocale) {
    ...
    var _iterator = _createForOfIteratorHelper$1(value2), _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        ...
        if (typeof item === "string") {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
              ...
              var fieldValue = ObjectUtils$5.resolveFieldData(item, field);
  ...
  filters: {
    startsWith: function startsWith(value2, filter3, filterLocale) {
      ...
      var filterValue = ObjectUtils$5.removeAccents(filter3.toString()).toLocaleLowerCase(filterLocale);
      var stringValue = ObjectUtils$5.removeAccents(value2.toString()).toLocaleLowerCase(filterLocale);
      return stringValue.slice(0, filterValue.length) === filterValue;
    },
    contains: function contains(value2, filter3, filterLocale) {
    ...
    notContains: function notContains(value2, filter3, filterLocale) {
      if (filter3 === void 0 || filter3 === null || typeof filter3 === "string" && filter3.trim() === "") {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
    ...
    endsWith: function endsWith2(value2, filter3, filterLocale) {
      if (filter3 === void 0 || filter3 === null || filter3.trim() === "") {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
    ...
    equals: function equals(value2, filter3, filterLocale) {
      if (filter3 === void 0 || filter3 === null || typeof filter3 === "string" && filter3.trim() === "") {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
      ...
      if (value2.getTime && filter3.getTime)
        return value2.getTime() === filter3.getTime();
      else
        return ObjectUtils$5.removeAccents(value2.toString()).toLocaleLowerCase(filterLocale) === ObjectUtils$5.removeAccents(filter3.toString()).toLocaleLowerCase(filterLocale);
    },
    notEquals: function notEquals(value2, filter3, filterLocale) {
      if (filter3 === void 0 || filter3 === null || typeof filter3 === "string" && filter3.trim() === "") {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
    ...
    "in": function _in(value2, filter3) {
      if (filter3 === void 0 || filter3 === null || filter3.length === 0) {
        return true;
      }
      for (var i = 0; i < filter3.length; i++) {
        if (ObjectUtils$5.equals(value2, filter3[i])) {
          return true;
        }
      }
      return false;
    },
    between: function between(value2, filter3) {
      ...
      if (value2.getTime)
        return filter3[0].getTime() <= value2.getTime() && value2.getTime() <= filter3[1].getTime();
      else
        return filter3[0] <= value2 && value2 <= filter3[1];
    },
    lt: function lt2(value2, filter3) {
      ...
      if (value2.getTime && filter3.getTime)
        ...
        return value2 < filter3;
    },
    lte: function lte(value2, filter3) {
      if (filter3 === void 0 || filter3 === null) {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
    ...
    gt: function gt2(value2, filter3) {
      if (filter3 === void 0 || filter3 === null) {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
    ...
    gte: function gte(value2, filter3) {
      if (filter3 === void 0 || filter3 === null) {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
    ...
    dateIs: function dateIs(value2, filter3) {
      if (filter3 === void 0 || filter3 === null) {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
      ...
      return value2.toDateString() === filter3.toDateString();
    },
    dateIsNot: function dateIsNot(value2, filter3) {
      if (filter3 === void 0 || filter3 === null) {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
    ...
    dateBefore: function dateBefore(value2, filter3) {
      if (filter3 === void 0 || filter3 === null) {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
    ...
    dateAfter: function dateAfter(value2, filter3) {
      if (filter3 === void 0 || filter3 === null) {
        return true;
      }
      if (value2 === void 0 || value2 === null) {
...
var PrimeReact$1 = /* @__PURE__ */ _createClass$6(function PrimeReact() {
  _classCallCheck$6(this, PrimeReact);
});
_defineProperty$6(PrimeReact$1, "ripple", false);
_defineProperty$6(PrimeReact$1, "inputStyle", "outlined");
_defineProperty$6(PrimeReact$1, "locale", "en");
_defineProperty$6(PrimeReact$1, "appendTo", null);
_defineProperty$6(PrimeReact$1, "cssTransition", true);
_defineProperty$6(PrimeReact$1, "autoZIndex", true);
_defineProperty$6(PrimeReact$1, "hideOverlaysOnDocumentScrolling", false);
_defineProperty$6(PrimeReact$1, "nonce", null);
_defineProperty$6(PrimeReact$1, "nullSortOrder", 1);
_defineProperty$6(PrimeReact$1, "zIndex", {
  modal: 1100,
  overlay: 1e3,
  menu: 1e3,
  tooltip: 1100,
...
_defineProperty$6(PrimeReact$1, "filterMatchModeOptions", {
...
_defineProperty$6(PrimeReact$1, "changeTheme", function(currentTheme, newTheme, linkElementId, callback) {
...
var useEventListener = function useEventListener2(_ref) {
  ...
  var bind2 = function bind3() {
    ...
    if (ObjectUtils$5.isNotEmpty(bindOptions.target)) {
      unbind();
...
var useOverlayScrollListener = function useOverlayScrollListener2(_ref) {
  ...
  var bind2 = function bind3() {
    ...
    if (!listenerRef.current && targetRef.current) {
      var nodes = scrollableParents.current = DomHandler.getScrollableParents(targetRef.current, PrimeReact$2.hideOverlaysOnDocumentScrolling);
      listenerRef.current = function(event) {
        return listener && listener(event);
      };
...
var IconBase = {
  ...
  getProps: function getProps(props) {
    return ObjectUtils$5.getMergedProps(props, IconBase.defaultProps);
  },
  getOtherProps: function getOtherProps(props) {
    return ObjectUtils$5.getDiffProps(props, IconBase.defaultProps);
  },
  getPTI: function getPTI(props) {
    var isLabelEmpty = ObjectUtils$5.isEmpty(props.label);
    ...
    return ObjectUtils$5.getMergedProps(otherProps, ptiProps);
  }
};
function _extends$a() {
...
var PortalBase = {
  ...
  getProps: function getProps2(props) {
    return ObjectUtils$5.getMergedProps(props, PortalBase.defaultProps);
  },
  getOtherProps: function getOtherProps2(props) {
    return ObjectUtils$5.getDiffProps(props, PortalBase.defaultProps);
  }
};
var Portal = /* @__PURE__ */ reactExports.memo(function(inProps) {
  var props = PortalBase.getProps(inProps);
  var _React$useState = reactExports.useState(props.visible && DomHandler.hasDOM()), _React$useState2 = _slicedToArray$9(_React$useState, 2), mountedState = _React$useState2[0], setMountedState = _React$useState2[1];
  ...
  if (element && mountedState) {
    var appendTo = props.appendTo || PrimeReact$2.appendTo || document.body;
...
var ComponentBase = {
  ...
  extend: function extend2() {
    ...
    var defaultProps2 = _objectSpread$5(_objectSpread$5({}, props.defaultProps), ComponentBase.defaultProps);
    var getProps6 = function getProps7(props2) {
      return ObjectUtils$5.getMergedProps(props2, defaultProps2);
    };
    var getOtherProps6 = function getOtherProps7(props2) {
      return ObjectUtils$5.getDiffProps(props2, defaultProps2);
    };
    var getPTItem = function getPTItem2() {
      var obj = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      var key = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
      var fKey = ObjectUtils$5.convertToFlatCase(key);
      return obj[Object.keys(obj).find(function(k2) {
        return ObjectUtils$5.convertToFlatCase(k2) === fKey;
      }) || ""];
    };
    var getPTValue = function getPTValue2() {
      ...
      return ObjectUtils$5.getPropValue(getPTItem(obj, key), params);
    };
    var setMetaData = function setMetaData2() {
      ...
      var ptm = function ptm2() {
        ...
        return ptmo((metadata.props || {}).pt, key, _objectSpread$5(_objectSpread$5({}, metadata), params));
      };
...
var Tooltip = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = reactExports.useState(false), _React$useState2 = _slicedToArray$8(_React$useState, 2), visibleState = _React$useState2[0], setVisibleState = _React$useState2[1];
  var _React$useState3 = reactExports.useState(props.position), _React$useState4 = _slicedToArray$8(_React$useState3, 2), positionState = _React$useState4[0], setPositionState = _React$useState4[1];
  var _React$useState5 = reactExports.useState(""), _React$useState6 = _slicedToArray$8(_React$useState5, 2), classNameState = _React$useState6[0], setClassNameState = _React$useState6[1];
  ...
  }), _useResizeListener2 = _slicedToArray$8(_useResizeListener, 2), bindWindowResizeListener = _useResizeListener2[0], unbindWindowResizeListener = _useResizeListener2[1];
  var _useOverlayScrollList = useOverlayScrollListener({
    ...
    when: visibleState
  }), _useOverlayScrollList2 = _slicedToArray$8(_useOverlayScrollList, 2), bindOverlayScrollListener = _useOverlayScrollList2[0], unbindOverlayScrollListener = _useOverlayScrollList2[1];
  ...
  var updateTooltipState = function updateTooltipState2(position) {
    updateText(currentTargetRef.current, function() {
      ...
      if (props.autoZIndex && !ZIndexUtils.get(elementRef.current)) {
        ZIndexUtils.set("tooltip", elementRef.current, PrimeReact$2.autoZIndex, props.baseZIndex || PrimeReact$2.zIndex["tooltip"]);
      }
  ...
  var align = function align2(target, coordinate, position) {
    ...
    if ((isMouseTrack(target) || currentPosition == "mouse") && coordinate) {
      ...
      var at2 = getTargetOption(target, "at") || props.at || pos.at;
      elementRef.current.style.padding = "0px";
      DomHandler.flipfitCollision(elementRef.current, target, my, at2, function(calculatedPosition) {
  ...
  var setTargetEventOperations = function setTargetEventOperations2(target, operation) {
    target = ObjectUtils$5.getRefElement(target);
    if (target) {
  ...
  var createElement = function createElement2() {
    var tooltipClassName = classNames("p-tooltip p-component", _defineProperty$4({}, "p-tooltip-".concat(positionState), true), props.className, classNameState);
    ...
    return /* @__PURE__ */ reactExports.createElement("div", rootProps, /* @__PURE__ */ reactExports.createElement("div", arrowProps), /* @__PURE__ */ reactExports.createElement("div", textProps, empty && props.children));
  };
  if (visibleState) {
...
var CSSTransition$1 = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ React.createElement(Transition$1, _extends$8({}, props, {
...
var CSSTransitionBase = {
  ...
  getProps: function getProps3(props) {
    return ObjectUtils$5.getMergedProps(props, CSSTransitionBase.defaultProps);
  },
  getOtherProps: function getOtherProps3(props) {
    return ObjectUtils$5.getDiffProps(props, CSSTransitionBase.defaultProps);
  }
};
...
var CSSTransition = /* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  ...
  var disabled = props.disabled || props.options && props.options.disabled || !PrimeReact$2.cssTransition;
  ...
  useUpdateEffect(function() {
    if (disabled) {
      var node = ObjectUtils$5.getRefElement(props.nodeRef);
      if (props["in"]) {
        onEnter(node, true);
  ...
  if (disabled) {
    ...
    var mergedProps = _objectSpread$4(_objectSpread$4(_objectSpread$4({}, mutableProps), props.options || {}), immutableProps);
...
var ObjectUtils$4 = /* @__PURE__ */ function() {
  ...
  _createClass$5(ObjectUtils2, null, [{
    key: "equals",
    value: function equals2(obj1, obj2, field) {
      if (field && obj1 && _typeof$7(obj1) === "object" && obj2 && _typeof$7(obj2) === "object")
        return this.resolveFieldData(obj1, field) === this.resolveFieldData(obj2, field);
      else
        return this.deepEquals(obj1, obj2);
    }
    ...
    value: function deepEquals(a, b) {
      if (a === b)
        return true;
      if (a && b && _typeof$7(a) == "object" && _typeof$7(b) == "object") {
        var arrA = Array.isArray(a), arrB = Array.isArray(b), i, length, key;
        if (arrA && arrB) {
          length = a.length;
          if (length !== b.length)
    ...
    value: function getRefElement(ref) {
      if (ref) {
        return _typeof$7(ref) === "object" && ref.hasOwnProperty("current") ? ref.current : ref;
      }
      return null;
    }
  }, {
    ...
    key: "isEmpty",
    value: function isEmpty(value2) {
      return value2 === null || value2 === void 0 || value2 === "" || Array.isArray(value2) && value2.length === 0 || !(value2 instanceof Date) && _typeof$7(value2) === "object" && Object.keys(value2).length === 0;
    }
  }, {
    key: "isNotEmpty",
    value: function isNotEmpty(value2) {
...
var SearchIcon = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = reactExports.useState(inProps.id), _React$useState2 = _slicedToArray$7(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
  reactExports.useEffect(function() {
  ...
  return /* @__PURE__ */ reactExports.createElement("svg", _extends$7({
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, pti), /* @__PURE__ */ reactExports.createElement("g", {
...
var ObjectUtils$3 = /* @__PURE__ */ function() {
  ...
  _createClass$4(ObjectUtils2, null, [{
    ...
    key: "isEmpty",
    value: function isEmpty(value2) {
      return value2 === null || value2 === void 0 || value2 === "" || Array.isArray(value2) && value2.length === 0 || !(value2 instanceof Date) && _typeof$6(value2) === "object" && Object.keys(value2).length === 0;
    }
  }, {
    key: "isNotEmpty",
    value: function isNotEmpty(value2) {
...
var SpinnerIcon = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = reactExports.useState(inProps.id), _React$useState2 = _slicedToArray$6(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
  reactExports.useEffect(function() {
...
var VirtualScrollerBase = {
  ...
  getProps: function getProps4(props) {
    return ObjectUtils$5.getMergedProps(props, VirtualScrollerBase.defaultProps);
  },
  getOtherProps: function getOtherProps4(props) {
    return ObjectUtils$5.getDiffProps(props, VirtualScrollerBase.defaultProps);
  }
};
...
var VirtualScroller = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = reactExports.useState(both ? {
    rows: 0,
    cols: 0
  } : 0), _React$useState2 = _slicedToArray$5(_React$useState, 2), firstState = _React$useState2[0], setFirstState = _React$useState2[1];
  var _React$useState3 = reactExports.useState(both ? {
    rows: 0,
    cols: 0
  } : 0), _React$useState4 = _slicedToArray$5(_React$useState3, 2), lastState = _React$useState4[0], setLastState = _React$useState4[1];
  var _React$useState5 = reactExports.useState(0), _React$useState6 = _slicedToArray$5(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  var _React$useState7 = reactExports.useState(both ? {
    rows: 0,
    cols: 0
  } : 0), _React$useState8 = _slicedToArray$5(_React$useState7, 2), numItemsInViewportState = _React$useState8[0], setNumItemsInViewportState = _React$useState8[1];
  var _React$useState9 = reactExports.useState(props.numToleratedItems), _React$useState10 = _slicedToArray$5(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = reactExports.useState(props.loading || false), _React$useState12 = _slicedToArray$5(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = reactExports.useState([]), _React$useState14 = _slicedToArray$5(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
  var elementRef = reactExports.useRef(null);
  ...
  var _useResizeListener = useResizeListener({
    ...
    when: !props.disabled
  }), _useResizeListener2 = _slicedToArray$5(_useResizeListener, 1), bindWindowResizeListener = _useResizeListener2[0];
  var _useEventListener = useEventListener({
    target: "window",
    type: "orientationchange",
    listener: function listener(event) {
    ...
    when: !props.disabled
  }), _useEventListener2 = _slicedToArray$5(_useEventListener, 1), bindOrientationChangeListener = _useEventListener2[0];
  ...
  var setSpacerSize = function setSpacerSize2() {
    ...
    if (items) {
      ...
      var setProp = function setProp2(_name, _value, _size) {
        ...
        return spacerStyle.current = _objectSpread$3(_objectSpread$3({}, spacerStyle.current), _defineProperty$2({}, "".concat(_name), (_value || []).length * _size + _cpos + "px"));
      };
      if (both) {
  ...
  var createLoaderItem = function createLoaderItem2(index2) {
    ...
    var content2 = ObjectUtils$5.getJSXElement(props.loadingTemplate, options);
  ...
  var createLoader = function createLoader2() {
    ...
    if (!props.loaderDisabled && props.showLoader && loadingState) {
      ...
      if (props.loadingTemplate) {
        ...
        content2 = ObjectUtils$5.getJSXElement(props.loaderIconTemplate, defaultContentOptions);
      }
  ...
  var createItem = function createItem2(item, index2) {
    var options = getOptions(index2);
    var content2 = ObjectUtils$5.getJSXElement(props.itemTemplate, item, options);
    return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, {
      key: options.index
    }, content2);
  };
  ...
  var createContent = function createContent2() {
    ...
    var content2 = /* @__PURE__ */ reactExports.createElement("div", {
      ref: _contentRef,
    ...
    if (props.contentTemplate) {
      var defaultOptions = {
        ...
        contentRef: function contentRef(el2) {
          return _contentRef.current = ObjectUtils$5.getRefElement(el2);
        },
        spacerRef: function spacerRef(el2) {
          return _spacerRef.current = ObjectUtils$5.getRefElement(el2);
        },
        stickyRef: function stickyRef(el2) {
          return _stickyRef.current = ObjectUtils$5.getRefElement(el2);
        },
        items: loadedItems(),
      ...
      return ObjectUtils$5.getJSXElement(props.contentTemplate, defaultOptions);
    }
    return content2;
  };
  if (props.disabled) {
    var content = ObjectUtils$5.getJSXElement(props.contentTemplate, {
      items: props.items,
      rows: props.items,
...
var Ripple = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function() {
  ...
  return PrimeReact$2.ripple ? /* @__PURE__ */ reactExports.createElement("span", {
    role: "presentation",
    ref: inkRef,
    className: "p-ink",
    onAnimationEnd
...
function _slicedToArray$4(arr, i) {
  return _arrayWithHoles$4(arr) || _iterableToArrayLimit$4(arr, i) || _unsupportedIterableToArray$1$1(arr, i) || _nonIterableRest$4();
}
var DropdownBase = {
  defaultProps: {
    __TYPE: "Dropdown",
  ...
  getProps: function getProps5(props) {
    return ObjectUtils$5.getMergedProps(props, DropdownBase.defaultProps);
  },
  getOtherProps: function getOtherProps5(props) {
    return ObjectUtils$5.getDiffProps(props, DropdownBase.defaultProps);
  }
};
var DropdownItem = /* @__PURE__ */ reactExports.memo(function(props) {
  ...
  var content = props.template ? ObjectUtils$5.getJSXElement(props.template, props.option) : props.label;
  ...
  }, content, /* @__PURE__ */ reactExports.createElement(Ripple, null));
});
...
var DropdownPanel = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(props, ref) {
  ...
  var createFooter = function createFooter2() {
    if (props.panelFooterTemplate) {
      var content = ObjectUtils$5.getJSXElement(props.panelFooterTemplate, props, props.onOverlayHide);
      return /* @__PURE__ */ reactExports.createElement("div", {
  ...
  var createEmptyMessage = function createEmptyMessage2(emptyMessage, isFilter) {
    var message = ObjectUtils$5.getJSXElement(emptyMessage, props) || localeOption$1(isFilter ? "emptyFilterMessage" : "emptyMessage");
    return /* @__PURE__ */ reactExports.createElement("li", {
  ...
  var createItem = function createItem2(option, index2) {
    ...
    if (props.optionGroupLabel) {
      var groupContent = props.optionGroupTemplate ? ObjectUtils$5.getJSXElement(props.optionGroupTemplate, option, index2) : props.getOptionGroupLabel(option);
  ...
  var createItems = function createItems2() {
    if (ObjectUtils$5.isNotEmpty(props.visibleOptions)) {
  ...
  var createFilterClearIcon = function createFilterClearIcon2() {
    if (props.showFilterClear && props.filterValue) {
      ...
      var icon = props.filterClearIcon || /* @__PURE__ */ reactExports.createElement(TimesIcon, iconProps);
  ...
  var createFilter = function createFilter2() {
    if (props.filter) {
      ...
      var icon = props.filterIcon || /* @__PURE__ */ reactExports.createElement(SearchIcon, {
        className: iconClassName
      });
      ...
      var content = /* @__PURE__ */ reactExports.createElement("div", {
      ...
      if (props.filterTemplate) {
        ...
        content = ObjectUtils$5.getJSXElement(props.filterTemplate, defaultContentOptions);
      }
      return /* @__PURE__ */ reactExports.createElement("div", {
  ...
  var createContent = function createContent2() {
    if (props.virtualScrollerOptions) {
      ...
      return /* @__PURE__ */ reactExports.createElement(VirtualScroller, _extends$4({
      ...
      }, /* @__PURE__ */ reactExports.createElement("ul", {
  ...
  var createElement = function createElement2() {
    var className = classNames("p-dropdown-panel p-component", props.panelClassName, {
      "p-input-filled": PrimeReact$2.inputStyle === "filled",
      "p-ripple-disabled": PrimeReact$2.ripple === false
    });
    var filter3 = createFilter();
    var content = createContent();
    var footer = createFooter();
    return /* @__PURE__ */ reactExports.createElement(CSSTransition, {
      nodeRef: ref,
...
var Dropdown = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = reactExports.useState(""), _React$useState2 = _slicedToArray$4(_React$useState, 2), filterState = _React$useState2[0], setFilterState = _React$useState2[1];
  var _React$useState3 = reactExports.useState(false), _React$useState4 = _slicedToArray$4(_React$useState3, 2), focusedState = _React$useState4[0], setFocusedState = _React$useState4[1];
  var _React$useState5 = reactExports.useState(false), _React$useState6 = _slicedToArray$4(_React$useState5, 2), overlayVisibleState = _React$useState6[0], setOverlayVisibleState = _React$useState6[1];
  var elementRef = reactExports.useRef(null);
  var overlayRef = reactExports.useRef(null);
  ...
  var currentSearchChar = reactExports.useRef(null);
  var isLazy = props.virtualScrollerOptions && props.virtualScrollerOptions.lazy;
  var hasFilter = ObjectUtils$5.isNotEmpty(filterState);
  var appendTo = props.appendTo || PrimeReact$2.appendTo;
  ...
  }), _useOverlayListener2 = _slicedToArray$4(_useOverlayListener, 2), bindOverlayListener = _useOverlayListener2[0], unbindOverlayListener = _useOverlayListener2[1];
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            ...
            if (filteredSubOptions && filteredSubOptions.length) {
              filteredGroups.push(_objectSpread$2(_objectSpread$2({}, optgroup), _defineProperty$1({}, "".concat(props.optionGroupChildren), filteredSubOptions)));
            }
          }
        } catch (err) {
          _iterator.e(err);
  ...
  var findNextOption = function findNextOption2(index2) {
    if (props.optionGroupLabel) {
      var groupIndex = index2 === -1 ? 0 : index2.group;
      var optionIndex = index2 === -1 ? -1 : index2.option;
    ...
    return findNextOptionInList(visibleOptions, index2);
  };
  var findNextOptionInList = function findNextOptionInList2(list, index2) {
    var i = index2 + 1;
    if (i === list.length) {
      return null;
    }
  ...
  var findPrevOption = function findPrevOption2(index2) {
    if (index2 === -1) {
      return null;
    }
    if (props.optionGroupLabel) {
      var groupIndex = index2.group;
      var optionIndex = index2.option;
    ...
    return findPrevOptionInList(visibleOptions, index2);
  };
  var findPrevOptionInList = function findPrevOptionInList2(list, index2) {
    var i = index2 - 1;
    if (i < 0) {
      return null;
    }
  ...
  var searchOption = function searchOption2(index2) {
    if (searchValue.current) {
      return searchOptionInRange(index2, visibleOptions.length) || searchOptionInRange(0, index2);
    }
    return null;
  };
  ...
  var searchOptionInGroup = function searchOptionInGroup2(index2) {
    var searchIndex = index2 === -1 ? {
      group: 0,
      option: -1
    } : index2;
  ...
  var onFilterInputChange = function onFilterInputChange2(event) {
    var filter3 = event.target.value;
    setFilterState(filter3);
    if (props.onFilter) {
      props.onFilter({
        originalEvent: event,
        filter: filter3
  ...
  var findOptionIndexInList = function findOptionIndexInList2(value2, list) {
    var key = equalityKey();
    return list.findIndex(function(item) {
      return ObjectUtils$5.equals(value2, getOptionValue(item), key);
    });
  };
  var isSelected = function isSelected2(option) {
    return ObjectUtils$5.equals(props.value, getOptionValue(option), equalityKey());
  };
  ...
  var onOverlayEnter = function onOverlayEnter2(callback) {
    ZIndexUtils.set("overlay", overlayRef.current, PrimeReact$2.autoZIndex, PrimeReact$2.zIndex["overlay"]);
    alignOverlay();
    callback && callback();
  };
  ...
  var alignOverlay = function alignOverlay2() {
    DomHandler.alignOverlay(overlayRef.current, inputRef.current.parentElement, props.appendTo || PrimeReact$2.appendTo);
  };
  ...
  var getOptionLabel = function getOptionLabel2(option) {
    return props.optionLabel ? ObjectUtils$5.resolveFieldData(option, props.optionLabel) : option && option["label"] !== void 0 ? option["label"] : option;
  };
  var getOptionValue = function getOptionValue2(option) {
    return props.optionValue ? ObjectUtils$5.resolveFieldData(option, props.optionValue) : option && option["value"] !== void 0 ? option["value"] : option;
  };
  var getOptionRenderKey = function getOptionRenderKey2(option) {
    return props.dataKey ? ObjectUtils$5.resolveFieldData(option, props.dataKey) : getOptionLabel(option);
  };
  var isOptionDisabled = function isOptionDisabled2(option) {
    if (props.optionDisabled) {
      return ObjectUtils$5.isFunction(props.optionDisabled) ? props.optionDisabled(option) : ObjectUtils$5.resolveFieldData(option, props.optionDisabled);
    }
  ...
  var getOptionGroupRenderKey = function getOptionGroupRenderKey2(optionGroup) {
    return ObjectUtils$5.resolveFieldData(optionGroup, props.optionGroupLabel);
  };
  ...
  var getOptionGroupChildren = function getOptionGroupChildren2(optionGroup) {
    return ObjectUtils$5.resolveFieldData(optionGroup, props.optionGroupChildren);
  };
  var updateInputField = function updateInputField2() {
    if (props.editable && inputRef.current) {
      var label = selectedOption ? getOptionLabel(selectedOption) : null;
      var value2 = label || props.value || "";
  ...
  reactExports.useEffect(function() {
    ObjectUtils$5.combinedRefs(inputRef, props.inputRef);
    ObjectUtils$5.combinedRefs(focusInputRef, props.focusInputRef);
  ...
  var createKeyboardHelper = function createKeyboardHelper2() {
    ...
    }, /* @__PURE__ */ reactExports.createElement("input", _extends$4({
      ref: focusInputRef,
      id: props.inputId,
      type: "text",
      readOnly: true,
  ...
  var createLabel = function createLabel2() {
    var label = ObjectUtils$5.isNotEmpty(selectedOption) ? getOptionLabel(selectedOption) : null;
    if (props.editable) {
      var value2 = label || props.value || "";
      return /* @__PURE__ */ reactExports.createElement("input", _extends$4({
        ref: inputRef,
        type: "text",
        defaultValue: value2,
      ...
      var content = props.valueTemplate ? ObjectUtils$5.getJSXElement(props.valueTemplate, selectedOption, props) : label || props.placeholder || "empty";
  ...
  var createClearIcon = function createClearIcon2() {
    if (props.value != null && props.showClear && !props.disabled) {
      ...
      var icon = props.clearIcon || /* @__PURE__ */ reactExports.createElement(TimesIcon, iconProps);
      return IconUtils.getJSXIcon(icon, _objectSpread$2({}, iconProps), {
        props
      });
    }
    return null;
  ...
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    var icon = props.dropdownIcon || /* @__PURE__ */ reactExports.createElement(ChevronDownIcon, {
      className: iconClassName
    });
  ...
  var hasTooltip = ObjectUtils$5.isNotEmpty(props.tooltip);
  var otherProps = DropdownBase.getOtherProps(props);
  var ariaProps = ObjectUtils$5.reduceKeys(otherProps, DomHandler.ARIA_PROPS);
  var className = classNames("p-dropdown p-component p-inputwrapper", {
    "p-disabled": props.disabled,
    "p-focus": focusedState,
    "p-dropdown-clearable": props.showClear && !props.disabled,
    "p-inputwrapper-filled": ObjectUtils$5.isNotEmpty(props.value),
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("div", _extends$4({
    ref: elementRef,
    id: props.id,
    className,
    style: props.style
  ...
  }), keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, /* @__PURE__ */ reactExports.createElement(DropdownPanel, _extends$4({
    ref: overlayRef,
    visibleOptions
  }, props, {
    appendTo,
  ...
  }))), hasTooltip && /* @__PURE__ */ reactExports.createElement(Tooltip, _extends$4({
    target: elementRef,
...
var ObjectUtils$2 = /* @__PURE__ */ function() {
  function ObjectUtils2() {
    _classCallCheck$3(this, ObjectUtils2);
  }
  _createClass$3(ObjectUtils2, null, [{
    key: "equals",
    value: function equals2(obj1, obj2, field) {
    ...
    key: "isEmpty",
    value: function isEmpty(value2) {
      return value2 === null || value2 === void 0 || value2 === "" || Array.isArray(value2) && value2.length === 0 || !(value2 instanceof Date) && _typeof$3(value2) === "object" && Object.keys(value2).length === 0;
    }
  }, {
    key: "isNotEmpty",
    value: function isNotEmpty(value2) {
...
var ExclamationTriangleIcon = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = reactExports.useState(inProps.id), _React$useState2 = _slicedToArray$3(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
  reactExports.useEffect(function() {
...
var ObjectUtils$1 = /* @__PURE__ */ function() {
  function ObjectUtils2() {
    _classCallCheck$2(this, ObjectUtils2);
  }
  _createClass$2(ObjectUtils2, null, [{
    key: "equals",
    value: function equals2(obj1, obj2, field) {
    ...
    value: function getRefElement(ref) {
      if (ref) {
        return _typeof$2(ref) === "object" && ref.hasOwnProperty("current") ? ref.current : ref;
      }
      return null;
    }
  }, {
    ...
    key: "isEmpty",
    value: function isEmpty(value2) {
      return value2 === null || value2 === void 0 || value2 === "" || Array.isArray(value2) && value2.length === 0 || !(value2 instanceof Date) && _typeof$2(value2) === "object" && Object.keys(value2).length === 0;
    }
  }, {
    key: "isNotEmpty",
    value: function isNotEmpty(value2) {
...
var InfoCircleIcon = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = reactExports.useState(inProps.id), _React$useState2 = _slicedToArray$2(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
  reactExports.useEffect(function() {
...
var ObjectUtils = /* @__PURE__ */ function() {
  ...
  _createClass$1(ObjectUtils2, null, [{
    key: "equals",
    value: function equals2(obj1, obj2, field) {
      if (field && obj1 && _typeof$1(obj1) === "object" && obj2 && _typeof$1(obj2) === "object")
        return this.resolveFieldData(obj1, field) === this.resolveFieldData(obj2, field);
      else
        return this.deepEquals(obj1, obj2);
    }
    ...
    value: function getRefElement(ref) {
      if (ref) {
        return _typeof$1(ref) === "object" && ref.hasOwnProperty("current") ? ref.current : ref;
      }
      return null;
    }
  }, {
    ...
    key: "isEmpty",
    value: function isEmpty(value2) {
      return value2 === null || value2 === void 0 || value2 === "" || Array.isArray(value2) && value2.length === 0 || !(value2 instanceof Date) && _typeof$1(value2) === "object" && Object.keys(value2).length === 0;
    }
  }, {
    key: "isNotEmpty",
    value: function isNotEmpty(value2) {
...
var TimesCircleIcon = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = reactExports.useState(inProps.id), _React$useState2 = _slicedToArray$1(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
  reactExports.useEffect(function() {
...
var PrimeReact2 = /* @__PURE__ */ _createClass(function PrimeReact3() {
...
var ToastMessage = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(props, ref) {
  ...
  var createCloseIcon = function createCloseIcon2() {
    ...
    var buttonIconProps = mergeProps({
      className: iconClassName
    }, ptm("buttonicon", parentParams), ptmo(pt2, "buttonicon", params));
    var icon = _closeIcon || /* @__PURE__ */ reactExports.createElement(TimesIcon, buttonIconProps);
    ...
    var buttonProps = mergeProps({
      ...
      onClick: onClose,
      "aria-label": ariaLabel
    }, ptm("button", parentParams), ptmo(pt2, "button", params));
    if (closable !== false) {
      return /* @__PURE__ */ reactExports.createElement("div", null, /* @__PURE__ */ reactExports.createElement("button", buttonProps, closeIcon2, /* @__PURE__ */ reactExports.createElement(Ripple, null)));
    }
    return null;
  };
  var createMessage = function createMessage2() {
    if (messageInfo) {
      var contentEl = ObjectUtils$5.getJSXElement(content, {
      ...
      var iconProps = mergeProps({
        className: iconClassName
      }, ptm("icon", parentParams), ptmo(pt2, "icon", params));
      var icon = _icon;
      if (!_icon) {
        switch (severity) {
          case "info":
            icon = /* @__PURE__ */ reactExports.createElement(InfoCircleIcon, iconProps);
            break;
          case "warn":
            icon = /* @__PURE__ */ reactExports.createElement(ExclamationTriangleIcon, iconProps);
            break;
          case "error":
            icon = /* @__PURE__ */ reactExports.createElement(TimesCircleIcon, iconProps);
            break;
          case "success":
            icon = /* @__PURE__ */ reactExports.createElement(CheckIcon, iconProps);
            break;
        }
      }
      ...
      }, ptm("text", parentParams), ptmo(pt2, "text", params));
      var summaryProps = mergeProps({
        className: "p-toast-summary"
      }, ptm("summary", parentParams), ptmo(pt2, "summary", params));
      var detailProps = mergeProps({
        className: "p-toast-detail"
      }, ptm("detail", parentParams), ptmo(pt2, "detail", params));
      return contentEl || /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, messageIcon, /* @__PURE__ */ reactExports.createElement("div", textProps, /* @__PURE__ */ reactExports.createElement("span", summaryProps, summary), detail && /* @__PURE__ */ reactExports.createElement("div", detailProps, detail)));
    }
    return null;
  };
  ...
  var messageProps = mergeProps({
    ...
    onMouseEnter,
    onMouseLeave
  }, ptm("message", parentParams), ptmo(pt2, "root", params));
  var contentProps = mergeProps({
    className: contentClassName,
    style: contentStyle
  }, ptm("content", parentParams), ptmo(pt2, "content", params));
  return /* @__PURE__ */ reactExports.createElement("div", messageProps, /* @__PURE__ */ reactExports.createElement("div", contentProps, message, closeIcon));
}));
ToastMessage.displayName = "ToastMessage";
var messageIdx = 0;
var Toast = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(function(inProps, ref) {
  var props = ToastBase.getProps(inProps);
  var _React$useState = reactExports.useState([]), _React$useState2 = _slicedToArray(_React$useState, 2), messagesState = _React$useState2[0], setMessagesState = _React$useState2[1];
  ...
  var remove = function remove2(messageInfo) {
    setMessagesState(function(m2) {
      return m2.filter(function(msg) {
  ...
  useUpdateEffect(function() {
    ZIndexUtils.set("toast", containerRef.current, PrimeReact$2.autoZIndex, props.baseZIndex || PrimeReact$2.zIndex["toast"]);
  ...
  var createElement = function createElement2() {
    ...
    return /* @__PURE__ */ reactExports.createElement("div", rootProps, /* @__PURE__ */ reactExports.createElement(TransitionGroup$1, null, messagesState && messagesState.map(function(messageInfo, index2) {
      var messageRef = /* @__PURE__ */ reactExports.createRef();
      return /* @__PURE__ */ reactExports.createElement(CSSTransition, {
        nodeRef: messageRef,
        ...
        onExited,
        options: props.transitionOptions
      }, /* @__PURE__ */ reactExports.createElement(ToastMessage, {
        ref: messageRef,
        messageInfo,
        index: index2,
        onClick: props.onClick,
...
const useComment = () => {
  ...
  const [pending, setPending] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const getComments = async (id2) => {
    setPending(true);
    const { res, err } = await API(`comments/by/poster/${id2}/1`);
    if (res) {
      setError(null);
...
function VideoPlayer({ url, ref }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "video-player-cart", children: /* @__PURE__ */ jsxRuntimeExports.jsx("video", { className: "video", src: url, controls: true, ref: videoRef }) })
    }
  );
}
function PlaySection({ sources, ref }) {
  const [url, setUrl] = reactExports.useState(null);
  const videoPlayerRef = reactExports.useRef(null);
  const toast = reactExports.useRef(null);
  const handleCopy = (link) => {
    navigator.clipboard.writeText(link);
    toast.current.show({ severity: "success", summary: "Copied", detail: "URL Copied" });
  };
  const handlePlay = (url2) => {
    setUrl(url2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "play-cart", children: sources && sources.map((source) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "source grid", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "source-play col-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: (e) => handlePlay(source.url), children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "pi pi-play" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "quality col", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: source.quality }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "link col-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleCopy(source.url), children: "Copy link" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "type col-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: source.type }) })
        ] }, source.id)) }),
...
function SingleMovie() {
  ...
  const playSectionRef = reactExports.useRef(null);
  const [isExpanded, setIsExpanded] = reactExports.useState(false);
  const [seasonId, setSeasonId] = reactExports.useState(null);
  ...
  const handleSeriePlayButton = (sources2) => {
    setSources(sources2);
    if (playSectionRef.current) {
      playSectionRef.current.style.display = "block";
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "single-movie", children: selectedMovie && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "info", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "image", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: selectedMovie.image }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "head", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "title", children: selectedMovie.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "country", children: [
          "محصول کشور ",
          selectedMovie.country[0].title
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "categories", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "list", ref: scrollRef, children: selectedMovie.genres.map((category, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "item", children: category.title }, i)) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "more", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "rating", children: [
            selectedMovie.rating.toFixed(1),
            " : نظر کاربران"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "imdb", children: [
            selectedMovie.imdb.toFixed(1),
            " : IMDB"
          ] })
        ] }),
        selectedMovie.type === "movie" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "play-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "play", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "play-btn", onClick: handleMoviePlayButton, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "pi pi-play" }),
            " Play"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "watched", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "i",
            {
              className: userData.watched.includes(selectedMovie.id) ? "pi pi-eye active" : "pi pi-eye",
              onClick: () => {
                userData.watched.includes(selectedMovie.id) ? markAsUnwatched(selectedMovie.id) : markAsWatched(selectedMovie.id);
              }
            }
          ) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "favorite", children: [
          is_favorite && /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "pi pi-heart-fill", onClick: delFa }),
          !is_favorite && /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "pi pi-heart", onClick: addFa })
        ] }),
        selectedMovie.type === "serie" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "seasons", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Dropdown,
          {
            value: seasonId,
            onChange: (e) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about", dangerouslySetInnerHTML: { __html: aboutText } }),
    text.length > 90 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "more-btn", onClick: handleToggleMore, children: isExpanded ? "Less..." : "More..." }),
    selectedMovie.type === "serie" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "episodes container", children: season && season?.episodes.map((episode) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "episode grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "episode-play col-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: (e) => handleSeriePlayButton(episode.sources), children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "pi pi-play" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "watched col-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "i",
        {
          className: userData.watched.includes(episode.id) ? "pi pi-eye active" : "pi pi-eye",
          onClick: () => {
            userData.watched.includes(episode.id) ? markAsUnwatched(episode.id) : markAsWatched(episode.id);
          }
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "title col", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: episode.title }) })
    ] }, episode.id)) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "comments container", children: [
      !Comments && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "load-comments", onClick: loadComments, children: [
        !pending && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "load-comments-btn", children: "load comments" }),
        pending && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading..." })
      ] }),
      Comments && Comments.map((comment) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "comment", id: comment.id, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "user", children: comment.user === "سردبیر مووی باکس" ? "سردبیر" : comment.user }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "content", children: decodeURIComponent(escape(atob(comment.content))).replace("مووی باکس", "ats movie").replace("موویباکس", "ats movie").replace("moviebox", "ats movie") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "created", children: comment.created })
      ] }))
    ] })
  ] }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    visible && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "single-movie-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SingleMovie, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "image", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: movie.image }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "info", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "label", children: movie.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "more flex justify-content-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "date", children: movie.year }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "country", children: movie.country[0].title })
            ] })
          ] })
        ]
      }
...
const useMovie = () => {
  const [Movies2, setMovies] = reactExports.useState([]);
  const [Favorites2, setFavorites] = reactExports.useState([]);
  const [pending, setPending] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const [page, setPage] = reactExports.useState(0);
  const getMovies = async (order = "created", filter3 = 0, getPage = 0) => {
    setPending(true);
    setPage(Math.abs(getPage));
    const orders = ["created", "rating", "imdb", "title", "view"];
    if (!orders.includes(order))
      order = "created";
    const { res, err } = await API(`movie/by/filtres/${filter3}/${order}/${page}/1`);
    if (res) {
      setError(null);
      setMovies(res.data);
    }
  ...
  const getMore = async (order = "created", filter3 = 0) => {
    ...
    if (!orders.includes(order))
      order = "created";
    const { res, err } = await API(`movie/by/filtres/${filter3}/${order}/${page + 1}/1`);
    if (res) {
      setError(null);
      setMovies([...Movies2, ...res.data]);
    }
    if (err) {
      setError(err);
      setMovies(null);
  ...
  const getFavorites = async (favoritesList) => {
    ...
    for (const favorite of favoritesList) {
      ...
      if (res) {
        Favorites2.push(res.data);
        setFavorites(Favorites2);
      }
    }
    setPending(false);
  };
  const getMovie = async (id2) => {
    const { res, err } = await API(`movie/by/${id2}/1`);
    return res;
  };
  return { Movies: Movies2, pending, error, getMovies, getMore, getFavorites, Favorites: Favorites2, getMovie };
};
function MovieList({ movies, title }) {
  const scrollRef = useHorizontalScroll();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "movie-list", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "info", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "title", children: title }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "list", ref: scrollRef, children: movies && movies.map((movie) => /* @__PURE__ */ jsxRuntimeExports.jsx(MovieCart, { movie }, movie.id)) })
  ] });
}
const useHomeData = () => {
...
function Home() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "home",
      style: {
        background: "linear-gradient(135deg,rgb(24, 23, 23),rgb(255, 255, 255),rgb(41, 39, 39))",
        // گرادیانت اضافه‌شده
        minHeight: "100vh",
        padding: "20px"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "data", children: Data.genres && Data.genres.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(MovieList, { movies: item.posters, title: item.title }, i)) }),
...
function Movies() {
  const orders = ["created", "rating", "imdb", "title", "view"];
  const [order, setOrder] = reactExports.useState("created");
  const [filter3, setFilter] = reactExports.useState(0);
  const { Movies: Movies2, getMovies, getMore, error, pending } = useMovie();
  const { Categories, getCategories } = useCategory();
  reactExports.useEffect(() => {
    getCategories();
    getMovies(order, filter3);
  }, [filter3, order]);
  const handleScroll = (e) => {
    const isEnd = e.target.scrollHeight - e.target.scrollTop === e.target.clientHeight;
    if (isEnd)
      getMore(order, filter3);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", onScroll: handleScroll, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "list grid", children: Movies2 && Movies2.map((movie) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "item col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovieCart, { movie }) }, movie.id)) }),
          !pending && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "load-more-div", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "load-more-btn", onClick: () => getMore(order, filter3), children: "Load More" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "telegram-ad", style: { textAlign: "center", padding: "10px", background: "#f8f9fa", marginTop: "20px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "برای دریافت آخرین فیلم‌ها به کانال تلگرام ما بپیوندید!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
...
function Series$1() {
  ...
  const [order, setOrder] = reactExports.useState("created");
  const [filter3, setFilter] = reactExports.useState(0);
  const { Series: Series2, getSeries, getMore, error, pending } = useSerie();
  const { Categories, getCategories } = useCategory();
  reactExports.useEffect(() => {
    getCategories();
    getSeries(order, filter3);
  }, [filter3, order]);
  const handleScroll = (e) => {
    const isEnd = e.target.scrollHeight - e.target.scrollTop === e.target.clientHeight;
    if (isEnd)
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", onScroll: handleScroll, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filters", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Dropdown,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "list grid", children: Series2 && Series2.map((series) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "item col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovieCart, { movie: series }) }, series.id)) }),
        pending && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: " Loading..." }) }),
        !pending && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "load-more-div", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "load-more-btn", onClick: () => getMore(order, filter3), children: "Load More" }) })
      ] })
    }
  );
...
function Search() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "movies container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "list grid", children: [
    Result?.posters && Result.posters.map((movie) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "item col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovieCart, { movie }) }, movie.id)),
    pending && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: " Loading..." }) })
  ] }) });
}
function Series() {
...
function About() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.content, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: styles.title, children: "هویج مووی" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.description, children: "خوش آمدید" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.description, children: "فیلم و سریال هارو با هویج مووی بدون سانسور تجربه کن" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.links, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "خرید اشتراک",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            style: styles.link,
            children: "Developer : Meraj"
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.snow })
  ] });
}
const styles = {
  container: {
  ...
  description: {
    ...
    marginBottom: "20px",
    fontWeight: "300"
    // Makes the description text lighter
  },
  links: {
    display: "flex",
  ...
  link: {
    ...
    borderRadius: "5px",
    boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)"
    // Adds a subtle shadow to the links
  },
  snow: {
    position: "absolute",
    top: "0",
...
function Favorites() {
  const { Favorites: Favorites2, getFavorites, pending } = useMovie();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "list grid", children: [
        Favorites2 && Favorites2.map((movie) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "item col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovieCart, { movie }) }, movie.id)),
        pending && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: " Loading..." }) })
      ] }) })
    }
  );
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "Main h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/movies", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Movies, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/series", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Series$1, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/favorites", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Favorites, {}) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/movie/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Series, {}) })
    ] }) })
  ] });
}
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(HashRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DataProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SearchProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) }) })
);
